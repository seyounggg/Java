...
public class 문자열_5 {
	...
	public static void main(String[] args) {
		...
		/*String s="Hello Java!!";
		//indexn  01234567891011
		System.out.println("원본: "+s);
		String s1=s.substring(6); //6번부터 마지막까지
		System.out.println(s1);
		String s2=s.substring(0,5); //0번부터 4까지(마지막번호는 제외 -> endIndex-1)
...
//			System.out.println(s);
		...
		/*
		 *  인덱스가 있는 위치값
		 *   1) .lastIndexOf() : 뒤에서부터 찾아서 나오는 위치
		 *   2) .indexOf() : 앞에서부터 찾아서 나오는 위치
		 */
		/*String sss="Hello Java";
		String a=sss.substring(sss.lastIndexOf("J"));
		System.out.println(a);*/
	    
	    //replace : 대소문자 구분!!
	    String str="Hello Java!!";
	    String sss=str.replace("a","b"); // 단어 한개씩 변경
	    System.out.println(sss);
	    String sss1=str.replace("Java","Oracle"); // 문자열도 변경 가능
