 ...
 *       문장2 => 에러발생
 *       문장3
 *       try안에서 ㅇ러 바생시에 에러난 위치부터 try끝까지는 수행하지 않는다
 *       ----------------------------------------------------
 ...
 *    문장6
 *    
 *    기본 =====>  문장1 -> 문장2 -> 문장3-> 문장5-> 문장6
 *    문장2에서 에러 발생 시 ==> 문장1 -> 문장4 -> 문장 5 -> 문장6
 * 
 */
public class 예외처리_예외복구_2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("문장4"); // 문장1~4까지는 정상 수행 가능
			int[] arr=new int[2];
			arr[2]=100;
			System.out.println("문장5:"+arr[2]); // 오류발생 -> 오류가 발생하면 catch로 이동!
			System.out.println("문장5");
